...
1. Направляй запрос агенту `consultant` в следующих случаях:
   - Нужна информация из документации 1С
   - Вопрос касается особенностей работы сервисов 1С
   - Требуется поиск в технической документации
   - Нужно порекомендовать клиенту сервис
